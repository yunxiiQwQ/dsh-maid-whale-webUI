...
[<img src="maid-whale-webui/preview/pet-working.png" alt="Cloud-whale companion working-state preview" width="480">](maid-whale-webui/preview/pet-working.png)
...
- The Node-side companion code and Python runtime are based on [QCYTSN/dsh-dafeiyu](https://github.com/QCYTSN/dsh-dafeiyu) (MIT). See [`maid-whale-webui/NOTICE`](maid-whale-webui/NOTICE) for full attribution.
